...
class MyAdapter(): RecyclerView.Adapter<MyAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.amountTxt.text = NumberFormat.getIntegerInstance().format(income.amount?.toInt())
        holder.binding.noteTxt.text = income.note
        holder.binding.adapterLayoutCardView.setBackgroundResource(R.drawable.item_background)
    }
